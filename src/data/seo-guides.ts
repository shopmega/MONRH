...
Pour obtenir une estimation précise personnalisée à votre salaire et votre ancienneté, utilisez notre simulateur officiel ci-dessous.`,
    faqs: [
      ...
      },
      {
        ...
        answer: "Il suffit de prendre votre salaire de base, vos primes régulières, et de les multiplier par le barème horaire correspondant à votre ancienneté. Vous pouvez utiliser le simulateur gratuit de SIMPAIE pour obtenir le résultat exact en quelques secondes."
      }
    ],
...
Utilisez le simulateur pour comparer rapidement un salaire brut annonce dans une offre et le montant net attendu chaque mois.`,
    faqs: [
      ...
      },
      {
        ...
        answer: "Oui. Le simulateur SIMPAIE permet de partir du net souhaite pour estimer le brut necessaire.",
      },
    ],
...
Cette page relie les outils SIMPAIE pour couvrir toute la sortie.`,
    faqs: [
      {
...
SIMPAIE ne remplace pas un conseil juridique, mais aide a preparer les questions et documents utiles avant d'agir.`,
    faqs: [
      {
      ...
      {
        question: "Quel outil SIMPAIE utiliser ?",
...
Utilisez cette page comme point d'entree vers les simulateurs et modeles SIMPAIE.`,
    faqs: [
      {
      ...
      {
        question: "SIMPAIE couvre-t-il les litiges ?",
