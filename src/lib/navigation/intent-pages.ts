...
export const INTENT_PAGES: Record<string, IntentPageDefinition> = {
  "salaire-brut-net": {
    ...
    primaryCtaHref: "/simulateurs/brut-net",
    secondaryCtaLabel: "Voir mon IR",
    secondaryCtaHref: "/simulateurs/ir-annuel",
    bullets: [
    ...
    related: [
      { title: "SMIG / SMAG", description: "Verifiez le minimum legal applicable.", href: "/simulateurs/conformite-smig" },
  ...
  "salaire-ir-igr": {
    ...
    primaryCtaHref: "/simulateurs/ir-annuel",
    secondaryCtaLabel: "Voir salaire net",
    secondaryCtaHref: "/simulateurs/brut-net",
    bullets: [
  ...
  "depart-licenciement": {
    ...
    primaryCtaHref: "/simulateurs/licenciement",
    secondaryCtaLabel: "Voir le preavis",
    secondaryCtaHref: "/simulateurs/duree-preavis",
    bullets: [
  ...
  "depart-demission": {
    ...
    primaryCtaHref: "/simulateurs/demission",
    secondaryCtaLabel: "Voir le preavis",
    secondaryCtaHref: "/simulateurs/duree-preavis",
    bullets: [
  ...
  "depart-preavis": {
    ...
    primaryCtaHref: "/simulateurs/duree-preavis",
    ...
    related: [
      { title: "Demission", description: "Mesurez l'impact financier de votre depart.", href: "/simulateurs/demission" },
      { title: "Licenciement", description: "Verifiez les droits en cas de rupture.", href: "/simulateurs/licenciement" },
  ...
  "litige-salaire-impaye": {
    ...
    primaryCtaHref: "/simulateurs/recouvrement-salaire-impaye",
  ...
  "litige-heures-sup": {
    ...
    primaryCtaHref: "/simulateurs/recouvrement-heures-supplementaires",
    secondaryCtaLabel: "Generer la reclamation",
    ...
    related: [
      { title: "Heures supplementaires", description: "Calculez les majorations normales.", href: "/simulateurs/heures-supplementaires" },
  ...
  "cnss-pension": {
    ...
    primaryCtaHref: "/simulateurs/pension-cnss",
    ...
    related: [
      ...
      { title: "Accident du travail", description: "Autres droits sociaux a verifier.", href: "/simulateurs/accident-travail" },
    ],
  },
  "conge-maternite": {
    ...
    primaryCtaHref: "/simulateurs/conge-maternite",
    ...
    related: [
      { title: "Arret maladie", description: "Comparez avec les autres absences indemnisees.", href: "/simulateurs/conge-maladie" },
      { title: "Conges acquis", description: "Visualisez vos autres droits de conge.", href: "/simulateurs/acquisition-conges" },
  ...
  "heures-supplementaires": {
    ...
    primaryCtaHref: "/simulateurs/heures-supplementaires",
    secondaryCtaLabel: "Voir les heures impayees",
    secondaryCtaHref: "/simulateurs/recouvrement-heures-supplementaires",
    bullets: [
    ...
    related: [
      { title: "Heures sup impayees", description: "Passez du calcul a la reclamation.", href: "/simulateurs/recouvrement-heures-supplementaires" },
      { title: "Jour ferie", description: "Comparez avec le travail en jour ferie.", href: "/simulateurs/compensation-jours-feries" },
  ...
  "arret-maladie": {
    ...
    primaryCtaHref: "/simulateurs/conge-maladie",
    secondaryCtaLabel: "Voir mes droits CNSS",
    secondaryCtaHref: "/simulateurs/pension-cnss",
    bullets: [
    ...
    related: [
      { title: "Conges acquis", description: "Visualisez vos autres droits d'absence.", href: "/simulateurs/acquisition-conges" },
      { title: "Conge maternite", description: "Consultez les autres absences indemnisees.", href: "/simulateurs/conge-maternite" },
